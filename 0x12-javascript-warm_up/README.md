...
## Description
This was the first JavaScript project I completed at [ALX](https://alx_africa.com).
...
* **6. Loop to languages**
  * [6-multi_languages_loop.js](./6-multi_languages_loop.js): JavaScript script that
  prints three lines (like 1-multi_languages.js) by using an array of string and a loop.
...
* **12. Object**
  * [12-object.js](./12-object.js): JavaScript script that updates and replaces
